...
if (!empty($_GET['q'])) {
    $id = $_GET['q'];
    $sql = "SELECT * FROM dnp_dealer WHERE id = '$id'";
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <input aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off" class="ui-autocomplete-input" id="location-name" name="location_name" value="<?php echo $row['title']; ?>" type="text"><i>*</i>													
                ...
                <tr>
                    <th>State/County:&nbsp;</th>
                    <td>
                        <input id="location-state" name="location_state" value="<?php echo $row['district']; ?>" type="text">
                    </td>
                </tr>
                <tr>
                    <th>Postcode:&nbsp;</th>
                ...
                <tr>
                    <th>Region:&nbsp;</th>
                    <td>
                        <input id="location-region" name="location_region" value="<?php echo $row['division']; ?>" type="text">
                    </td>
                </tr>
                <tr>
                    <th>Country:&nbsp;</th>
