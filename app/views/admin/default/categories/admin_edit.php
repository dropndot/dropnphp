...
<div class="content">
    <div class="form">
        <form name="add_category" action="<?php echo BASE_URL?>admin/index.php?controller=categories&action=edit" method="post">
            ...
            <input type="hidden" name="identifier" value="<?php echo !empty($row['identifier'])?$row['identifier']:''?>" />
<!--            <p><label>Description: </label><textarea name="description" class="large" cols="40" rows="10"><?php echo !empty($row['description'])?$row['description']:''?></textarea></p>-->
            <p><label>Ordering: </label><input type="text" name="ordering" value="<?php echo !empty($row['ordering'])?$row['ordering']:''?>" class="medium"></p>
...
<!--            <p><label>Meta key: </label><textarea name="meta_key" class="small" cols="20" rows="5"><?php echo !empty($row['meta_key'])?$row['meta_key']:''?></textarea></p>
            <p><label>Meta desc: </label><textarea name="meta_desc" class="small" cols="20" rows="5"><?php echo !empty($row['meta_desc'])?$row['meta_desc']:''?></textarea></p>-->
